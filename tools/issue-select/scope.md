...
I have experience with Python, Flask, SQLAlchemy, REST APIs, Git, GitHub, and working with service-layer application code. I have also worked on debugging existing projects, reading unfamiliar codebases, writing and updating tests, and making documentation changes as part of course assignments.

For a first contribution, I am most comfortable with small, well-defined backend bugs, API or service-layer fixes, test improvements, and documentation changes. I want to get better at understanding larger existing codebases, tracing issues across multiple files, and contributing through a real pull request workflow.

I would prefer to avoid issues that require major architectural changes, deep framework internals, large frontend rewrites, or broad changes with unclear scope. I am looking for an issue with clear evidence of what is wrong, a reasonably bounded fix, and a good way to verify the result.
